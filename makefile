...
$(BIN)/$(EXE): $(OBJ)/scheduler.o $(OBJ)/Student.o $(OBJ)/Course.o $(OBJ)/ExtraFunctions.o $(OBJ)/MichaelList.o
	$(CC) $(FLAGS) $(OBJ)/scheduler.o -o $@

$(OBJ)/scheduler.o: scheduler.cpp Student.h Course.h ExtraFunctions.cpp MichaelList.h
	$(CC) $(FLAGS) -c scheduler.cpp -o $@

$(OBJ)/Course.o: Course.cpp Course.h Student.h MichaelList.h
	$(CC) $(FLAGS) -c Course.cpp -o $@
	
$(OBJ)/Student.o: Student.cpp Student.h Course.h MichaelList.h
...
$(OBJ)/MichaelList.o: MichaelList.cpp MichaelList.h
